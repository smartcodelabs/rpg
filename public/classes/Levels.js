...
// Level 0: Erstelle ein Exit-Objekt, das in Level 1 wechselt
        const exitObj0 = new GameObject(this.game, 920, 170, 25, 25, colorExit, 'exit', [{
            ...
            // Alternativ: { type: "enemy", count: 5 } für 5 besiegte Gegner
        ]);
        ...
        this.levels.push(new Level(
            ...
            [
                ...
                new Enemy(this.game, 480, 110, 32, 32, 'img:/enemys/enemy1.png'),
                new Enemy(this.game, 390, 590, 32, 32, 'img:/enemys/enemy1.png'),
